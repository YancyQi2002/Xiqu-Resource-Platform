                  ...
                  <thead class="bg-gray-100 dark:bg-gray-700">
                    <tr>
                      <th
                        ...
                        scope="col"
                        class="py-3 px-6 text-center text-base font-bold uppercase tracking-wider text-gray-700 dark:text-gray-400"
                      >
                        {{ item.title }}
                      </th>
                      <th
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="whitespace-nowrap text-right text-sm font-medium">
                        <a
                          class="text-blue-600 hover:cursor-pointer dark:text-blue-500"
